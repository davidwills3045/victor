    ...
    <>
      <div className="one-stop">
        <div className="one-stop-content-1">
          <h2>
            One-stop platform for all <br /> things{" "}
            <span>Nigerian Politics</span>
          </h2>
          <p>
            Our Mobile App is the middle ground between you and your leaders.
        ...
        <div className="one-stop-content-2">
          <img src={rightPhone} alt="" className="rightphone" />
        </div>
      </div>
    </>
  );
